package shu.fragmenttest.UI.tabsort.tabsortadapter;
...
public class FirstClassAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.tab_sort_left_listview_item, null);
        ...
        if (position == selectedPosition){
            ...
            convertView.setBackgroundResource(R.drawable.tab_sort_first_selector_left_normal);
        }
