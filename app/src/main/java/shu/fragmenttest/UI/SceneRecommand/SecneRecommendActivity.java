...
import shu.fragmenttest.entity.Suit;
...
//        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCardAdapter.addCardItem(new Suit("场景推荐1"));
        mCardAdapter.addCardItem(new Suit("场景推荐2"));
        mCardAdapter.addCardItem(new Suit("场景推荐3"));
        mCardAdapter.addCardItem(new Suit("场景推荐4"));
