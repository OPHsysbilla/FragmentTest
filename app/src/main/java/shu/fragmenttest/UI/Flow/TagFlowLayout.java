package shu.fragmenttest.UI.Flow;
...
//            lp.rightMargin = clp.rightMargin;
            ...
            {
                MarginLayoutParams lp = new MarginLayoutParams(dip2px(mContext,LayoutParams.WRAP_CONTENT),dip2px(mContext,LayoutParams.WRAP_CONTENT));
